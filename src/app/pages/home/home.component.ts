...
import { ItemTvShows } from 'src/app/components/itemtvshows/itemtvshows';
...
export class HomeComponent implements OnInit {
  ...
  popularTvShows: any[] = [];
  ItemtvShows:any;
  // import("g:/movies-app-full-code/src/app/components/itemtvshows/itemtvshows").ItemTvShows[];
